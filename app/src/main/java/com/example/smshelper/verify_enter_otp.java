...
public class verify_enter_otp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        get_otp_backend = getIntent().getStringExtra("backendotp");
            ...
            public void onClick(View view) {
                ...
                if (!pinView.getText().toString().trim().isEmpty()){
                    ...
                    if (get_otp_backend != null) {
                                ...
                                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                    ...
                                    public void onComplete(@NonNull Task<AuthResult> task) {
                                        ...
                                        if (task.isSuccessful()) {
                                            ...
                                            Toast.makeText(verify_enter_otp.this, "Enter the correct otp", Toast.LENGTH_LONG).show();
                        ...
                        Toast.makeText(verify_enter_otp.this, "Please check your internet connection", Toast.LENGTH_LONG).show();
                    }

                } else {
                    Toast.makeText(verify_enter_otp.this, "Please enter all numbers", Toast.LENGTH_LONG).show();
                }
...
//                                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                            ...
                            public void onVerificationFailed(@NonNull FirebaseException e) {
                                Toast.makeText(verify_enter_otp.this, e.getMessage(), Toast.LENGTH_LONG).show();
                            }
                            ...
                            public void onCodeSent(@NonNull String newbackendotp, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                                ...
                                Toast.makeText(verify_enter_otp.this, "Otp sended succussfully", Toast.LENGTH_LONG).show();
